...
export default class Lighthouse extends Group {
    constructor () {
        ...
        const bodyTex = new TextureLoader().load('../textures/Brick-4096.jpg');
        ...
        const deckTex = new TextureLoader().load('../textures/dark_brick-4096x1024.jpg');
        ...
        const pedestalTex = new TextureLoader().load('../textures/wood-2048x2048.jpg');
        ...
        for (var i = 0; i < NUM_SUPPORTS; i++) {
            ...
            var supportTex = new TextureLoader().load('../textures/wood-2048x2048.jpg');
        ...
        const roofTex = new TextureLoader().load('../textures/wood-2048x2048.jpg');
